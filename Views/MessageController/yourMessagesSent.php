...
<div class="board">
    <div class="messagesSites">
            <form action="" method="GET" id="site">
                <button type="submit" id="messageSite">ODEBRANE</button>
                <input type="hidden" name="page" value="messages">
            </form>
            <form action="" method="GET" id="site">
                <button type="submit" id="messageSite" disabled>WYSŁANE</button>
                <input type="hidden" name="page" value="messagesSent">
            </form>
    </div>
    <h1 style="font-size:40px;text-align:center">WYSŁANE WIADOMOŚCI</h1><br>
...
<?php $max = count($names);
    for($i=0; $i<$max; $i++){ ?>
            <form action="" method="GET" id="post">
                ...
                <input type="submit" name="button" id="button" value="Do: <?= $names[$i] ?>" />
                <div class="wraper">
